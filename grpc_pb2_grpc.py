...
class ChatServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ChatStream = channel.unary_stream(
                ...
                response_deserializer=grpc__pb2.Note.FromString,
                _registered_method=True)
        self.SendNote = channel.unary_unary(
                '/grpc.ChatServer/SendNote',
                request_serializer=grpc__pb2.Note.SerializeToString,
...
def add_ChatServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ChatStream': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=grpc__pb2.Note.SerializeToString,
            ),
            'SendNote': grpc.unary_unary_rpc_method_handler(
                    servicer.SendNote,
                    request_deserializer=grpc__pb2.Note.FromString,
...
class ChatServer(object):
    ...
    def SendNote(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/grpc.ChatServer/SendNote',
            grpc__pb2.Note.SerializeToString,
